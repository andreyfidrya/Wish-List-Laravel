...
<h2>Список желаний. Категория: {{$fishing}}</h2>                    
...
Общая сумма товаров в категории рыбалка: <strong>{{$sum}} USD</strong><br>
Количество товаров в категории рыбалка: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в категории рыбалка: <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории рыбалка: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
