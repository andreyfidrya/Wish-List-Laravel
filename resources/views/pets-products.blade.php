...
<h2>Список желаний. Категория: {{$pets}}</h2>
...
Общая сумма товаров в категории домашние животные: <strong>{{$sum}} USD</strong><br>
Количество товаров в категории домашние животные: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в категории домашние животные: <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории домашние животные: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
