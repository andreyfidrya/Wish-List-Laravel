...
<h2>Список желаний. Категория: {{$lera}}</h2>
...
Общая сумма товаров в категории желания Леры: <strong>{{$sum}} USD</strong><br>
Количество товаров в категории желания Леры: <strong>{{$productnumber}} </strong><br>
Самый дешевый товар в категории желания Леры: <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории желания Леры: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
