...
<h2>Список желаний. Категория: {{$flat}}</h2>
...
Общая сумма товаров в категории квартира: <strong>{{$sum}} USD</strong><br>
Количество товаров в категории квартира: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в категории квартира: <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории квартира: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
