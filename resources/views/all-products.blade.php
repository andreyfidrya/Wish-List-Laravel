...
<head>
    ...
    <a href="{{ route('trash') }}" class="btn btn-danger" style="float:right">Куплено</a>
...
<h2 align="center">Список желаний. Все категории.</h2>
...
Общая сумма товаров во всех категориях: <strong>{{$sum}} USD</strong><br>
Количество товаров во всех категориях: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в списке желаний: <strong>{{$cheapestproduct->productname}}</strong> в категории <strong>{{$cheapestproduct->category}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в списке желаний: <strong>{{$mostexpensiveproduct->productname}}</strong> в категории <strong>{{$mostexpensiveproduct->category}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
