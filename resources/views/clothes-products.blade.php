...
<h2>Список желаний. Категория: {{$clothes}}</h2>
...
Общая сумма товаров в категории одежда: <strong>{{$sum}} USD</strong><br> 
Количество товаров в категории одежда: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в категории одежда <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории одежда: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
