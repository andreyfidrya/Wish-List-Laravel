...
<h2>Список желаний. Категория: {{$tourism}}</h2>
...
Общая сумма товаров в категории туризм: <strong>{{$sum}} USD</strong><br> 
Количество товаров в категории туризм: <strong>{{$productnumber}}</strong><br>
Самый дешевый товар в категории туризм: <strong>{{$cheapestproduct->productname}}</strong> и его цена: <strong>{{$cheapestproduct->price}} USD</strong><br>
Самый дорогой товар в категории туризм: <strong>{{$mostexpensiveproduct->productname}}</strong> и его цена: <strong>{{$mostexpensiveproduct->price}} USD</strong>
